...
public class SensorVRControllerSendVectorMsg : SceneObjectScript

{
    ...
    private void ActionToPerform(Vector LeftPos, Vector LeftWorldPos, Vector RightPos, Vector RightWorldPos, Vector AgentPos, Quaternion AgentRot)
    {
